...
public class MainActivity extends AppCompatActivity {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener = new BottomNavigationView.OnNavigationItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            EditText etSubTopic = findViewById(R.id.subTopic);
            EditText etPubTopic = findViewById(R.id.pubTopic);
            EditText etPubMsg = findViewById(R.id.pubMsg);
            EditText etBroker = findViewById(R.id.urlBroker);
            EditText etUName = findViewById(R.id.clientUn);
            EditText etPWord = findViewById(R.id.clientPw);
            String msg_new = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        client = pahoMqttClient.getMqttClient(getApplicationContext(), // Connect to MQTT Broker
                urlBroker, clientid, username, password);
    ...
    private Runnable RunScheduledTasks = new Runnable() {
        public void run() {
            ...
            TextView tvMessage = findViewById(R.id.cnxStatus);
            String msg_new = "";
